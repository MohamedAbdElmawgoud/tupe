...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["create-subscripe-create-subscripe-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCreateSubscripeCreateSubscripePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCreateSubscripeCountryTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var videos = ["Cars & Vehicles", "Comedy", "Education", "Entertainment", "Film & Animation", "Gaming", "How-to & Style", "Music", "News & Politics", "Non-profits & Activism", "People & Blogs", "Pets & Animals", "Science & Technology", "Sport", "Travel & Events"];
    /***/
  },
  ...
  /***/
  function srcAppCreateSubscripeCreateSubscripeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateSubscripePageRoutingModule", function () {
      return CreateSubscripePageRoutingModule;
    });
    /* harmony import */
    ...
    var _create_subscripe_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./create-subscripe.page */
    ...
    var CreateSubscripePageRoutingModule = function CreateSubscripePageRoutingModule() {
      _classCallCheck(this, CreateSubscripePageRoutingModule);
    };

    CreateSubscripePageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppCreateSubscripeCreateSubscripeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateSubscripePageModule", function () {
      return CreateSubscripePageModule;
    });
    /* harmony import */
    ...
    var _create_subscripe_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./create-subscripe-routing.module */
    "./src/app/create-subscripe/create-subscripe-routing.module.ts");
    /* harmony import */


    var _create_subscripe_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./create-subscripe.page */
    "./src/app/create-subscripe/create-subscripe.page.ts");
    /* harmony import */
    ...
    var CreateSubscripePageModule = function CreateSubscripePageModule() {
      _classCallCheck(this, CreateSubscripePageModule);
    };

    CreateSubscripePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateModule"], _create_subscripe_routing_module__WEBPACK_IMPORTED_MODULE_5__["CreateSubscripePageRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"]],
  ...
  /***/
  function srcAppCreateSubscripeCreateSubscripePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCreateSubscripeCreateSubscripePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreateSubscripePage", function () {
      return CreateSubscripePage;
    });
    /* harmony import */
    ...
    var _firebase_firebase_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../firebase/firebase.service */
    "./src/app/firebase/firebase.service.ts");
    /* harmony import */


    var _firebase_youtube__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../firebase/youtube */
    ...
    var _country__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./country */
    "./src/app/create-subscripe/country.ts");
    /* harmony import */
    ...
    var src_app_firebase_setting_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var CreateSubscripePage = /*#__PURE__*/function () {
      function CreateSubscripePage(userService, youtube, alertController, subscribes, route, translate, setting, storage) {
        _classCallCheck(this, CreateSubscripePage);
      ...
      _createClass(CreateSubscripePage, [{
        key: "ngOnInit",
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.userService.getDataOfUser();
        ...
        key: "videoChange",
        value: function videoChange(e) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            var scrubbed, videoData, channelData;
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    scrubbed = e.target.value.slice(e.target.value.indexOf('=') + 1);
                    ...
                    _context2.next = 4;
                    return this.youtube.getVideoData(scrubbed);
                  ...
                  case 4:
                    ...
                    _context2.next = 10;
                    return this.youtube.getChannelData(videoData.items[0].snippet.channelId);
        ...
        key: "convert_time",
        value: function convert_time(duration) {
        ...
        key: "saveStepOne",
        value: function saveStepOne(c, v) {
                ...
                switch (_context3.prev = _context3.next) {
                  case 0:
                    if (this.userChannel.channel) {
                      user = this.userService.getDataOfUser(this.user.uid).then(function (e) {
                        var UserEdited = Object.assign({}, e.docs[0].data(), {
                          channel: _this.userChannel
                        });

                        _this.userService.updateUser(UserEdited);
        ...
        key: "createComp",
        value: function createComp(sec, view) {
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 12:
                    user = _context6.sent;
                    this.userService.getDataOfUser(user).then(function (status) {
                      if (status.docs[0].data().vip) {
                        console.log('account is vip');

                        if (!status) {
                          _this2.setting.getsettingsList(function (res) {
                            return res;
                          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(function (changes) {
                        ...
                        _this2.UpdateUSerPoints(-_this2.points);
        ...
        key: "onChange",
        value: function onChange(sec, view) {
        ...
        value: function UpdateUSerPoints(points) {
          ...
          var user = this.userService.getDataOfUser(this.user.uid).then(function (e) {
            var UserEdited = Object.assign({}, e.docs[0].data(), {
              point: e.docs[0].data().point + points
            });

            _this3.userService.updateUser(UserEdited);

            _this3.subscribes.createSubscribe(_this3.camping);

            _this3.presentAlert('Added success');
          });
        }
      }]);
    ...
    CreateSubscripePage.ctorParameters = function () {
      return [{
    ...
    CreateSubscripePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-create-subscripe',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./create-subscripe.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/create-subscripe/create-subscripe.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./create-subscripe.page.scss */
      "./src/app/create-subscripe/create-subscripe.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_firebase_firebase_service__WEBPACK_IMPORTED_MODULE_2__["FirebaseService"], _firebase_youtube__WEBPACK_IMPORTED_MODULE_3__["YoutubeService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["AlertController"], _firebase_subscripe__WEBPACK_IMPORTED_MODULE_4__["subscribesService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateService"], src_app_firebase_setting_service__WEBPACK_IMPORTED_MODULE_9__["SettingService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_11__["Storage"]])], CreateSubscripePage);
    /***/
  }
}]);
//# sourceMappingURL=create-subscripe-create-subscripe-module-es5.js.map